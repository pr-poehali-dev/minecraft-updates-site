...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#313338] to-[#1e1f22]">
      <header className="py-6 px-4 md:px-8 lg:px-12 bg-[#1e1f22]/80 backdrop-blur-sm border-b border-gray-800 sticky top-0 z-10">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <a href="#mobs" className="text-gray-300 hover:text-white transition-colors">Мобы</a>
            <a href="#biomes" className="text-gray-300 hover:text-white transition-colors">Биомы</a>
            <a href="#blocks" className="text-gray-300 hover:text-white transition-colors">Блоки</a>
          </nav>
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <section className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button className="bg-green-600 hover:bg-green-700 hover-scale">Узнать больше</Button>
            <Button variant="outline" className="text-white border-gray-700 hover:bg-gray-800">
        ...
        <section id="features" className="mb-20 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="bg-gray-800 border-gray-700 text-white hover-scale">
              <CardHeader>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          {/* Mobs Section */}
          <section id="mobs" className="lg:col-span-1 scroll-mt-20">
          ...
          {/* Biomes Section */}
          <section id="biomes" className="lg:col-span-1 scroll-mt-20">
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
              <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
          ...
          {/* Blocks Section */}
          <section id="blocks" className="lg:col-span-1 scroll-mt-20">
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
              <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
